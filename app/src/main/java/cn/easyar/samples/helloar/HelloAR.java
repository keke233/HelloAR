...
public class HelloAR
{
    ...
    public void initialize()
    {
        ...
        //同时检测2个
        boolean b = tracker.setSimultaneousNum(2);
        Log.e("最大检测数设置成功：" , b+"");
        loadFromImage(tracker, "idback.jpg", "idback");
        loadFromImage(tracker, "img1.png", "img1");
        loadFromImage(tracker, "img2.png", "img2");
        loadFromImage(tracker, "img3.png", "img3");
        loadFromJson(tracker, "sightplus.json");
//        tracker.setSimultaneousNum(5);
